...
public class Default_C_Factory {
	...
	public static void makeAll() {
		ServiceLocator.get(Drivetrain_S.class).setDefaultCommand(new ArcadeDriveWithJoysticks_DC());
		ServiceLocator.get(Climber_S.class).setDefaultCommand(new RunClimber_DC());
	}
