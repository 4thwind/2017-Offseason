...
public class BehaviorKeys {
	...
	public static final String TICK_CONVERSION = "drivetrain.conversion";

	public static final String GYRO_P = "gyro.p";
	public static final String GYRO_I = "gyro.i";
	public static final String GYRO_D = "gyrp.d";
	public static final String GYRO_F = "gyro.f";
}
